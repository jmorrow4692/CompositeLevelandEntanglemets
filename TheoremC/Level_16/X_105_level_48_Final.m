...
Phi2:= CanonicalMap(CC);
CQ2<X,Y,Z> := CanonicalImage(CC,Phi2);
P<X,Y,Z> := PolynomialRing(Rationals(),3);
boo, DQ2 := IsCoercible(P,DefiningPolynomial(CQ2));

assert (IsIsomorhpic(CQ,CQ2) eq true);
