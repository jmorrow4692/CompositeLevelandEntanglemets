...
/*
We use the data from RZB to narrow down the subgroups that could exist for the composite-(8,3) level. Once we have these possible subgroups, we check by hand that they do in fact lie over the subgroups of level 4 that occur as a composite-(4,3) level image.

CLEAN UP X_{H_42,B}(24)
*/
...
// X_{H_29,G_4}(24) clearly has 1 CM point
...
//X_{H_35,G_4}(24) clearly has 1 CM point
...
//X_{H_40,G_4}(24) has 3 CM points
...
// X_{H_91,G_4}(24 has 4 CM points
...
canC := Image(phi);
assert (Genus(canC) eq 1);
MordellWeilShaInformation(Jacobian(canC));
...
//X_{H_49,G_4}(24) has 1 cuspidal point
...
//X_{H_33,G_3}(24) has 1 cuspidal point
...
//X_{H_34,B}(24) has 1 cuspidal point
...
//X_{H_36,B}(24) has 3 cuspidal points
...
//X_{H_44,B}(24) has 1 cuspidal point
